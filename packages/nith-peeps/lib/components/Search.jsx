...
function buildBranches() {
	let list = [
		{ value: "select-branch", label: "select-branch", disabled: true },
	];
...
class Search extends Component {
	constructor(props) {
		...
		this.branchSelectOnChangeHandler = this.branchSelectOnChangeHandler.bind(
			this,
		);
...
const mapDispatchToProps = dispatch =>
	bindActionCreators(getActions().searchBg, dispatch);
